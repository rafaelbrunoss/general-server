export const USER_UI_IDENTIFIERS = {
  UI_MAPPER: Symbol.for('UIMapper'),
  USER_MAPPER: Symbol.for('UserUIMapper'),
};

export const USER_UI_APPLICATION_IDENTIFIERS = {
...
export const USER_GRAPHQL_IDENTIFIERS = {
...
export const USER_UI_MAPPINGS_IDENTIFIERS = {
